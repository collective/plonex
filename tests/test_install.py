    ...
    def test_requirements_preserve_git_constraint(self):
        with temp_cwd():
            ...
            (install.constraints_d_folder / "git.txt").write_text(
                ...
                "git+https://github.com/plone/plone.recipe.zope2instance.git@main\n"
            )
            ...
            with mock_remote_constraints():
                with install:
                    self.assertListEqual(
                        ...
                        [
                            "# This file is generated by plonex",
                            "plone.recipe.zope2instance@git+https://github.com/plone/plone.recipe.zope2instance.git@main",  # noqa: E501
                        ],
                    )
                    ...
                    with mock.patch.object(InstallService, "ensure_virtualenv"):
                        with mock.patch.object(install, "run_command"):
                            with mock.patch.object(
                                ...
                                return_value=(
                                    "plone.recipe.zope2instance @ "
                                    "git+https://github.com/plone/"
                                    "plone.recipe.zope2instance.git@"
                                    "0123456789abcdef\n"
                                ),
                            ):
                                with install:
