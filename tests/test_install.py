                ...
                with mock_remote_constraints():
                    with install:
                        self.assertListEqual(
                            ...
                            [
                                "# This file is generated by plonex",
                                f"-r {cwd / 'etc' / 'requirements.d' / '010-local.txt'}",  # noqa: E501
                                "waitress",
                                "black",
                            ],
                        )
                ...
                with mock_remote_constraints():
                    with install:
                        self.assertListEqual(
                            ...
                            [
                                "# This file is generated by plonex",
                                f"-r {str(install.requirements_d_folder)}/010-local.txt",  # noqa: E501
                                f"-r {str(child_profile / 'etc' / 'requirements.d')}/010-child.txt",  # noqa: E501
                                f"-r {str(base_profile / 'etc' / 'requirements.d')}/010-base.txt",  # noqa: E501
                            ],
                        )
                        self.assertListEqual(
                            install.constrainst_txt.read_text().splitlines(),
